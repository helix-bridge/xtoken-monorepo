      ...
      <div className="relative">
        ...
        >
          <div className={`${className}`}>
            {/* header */}
            <div
              className="gap-medium rounded-t-medium px-medium py-large lg:px-large grid items-center bg-white/20 text-sm font-extrabold text-white"
            ...
            <div className="relative">
              {/* loading */}
              <ComponentLoading loading={!!loading} className="rounded-b-medium" color="white" />

              {/* content */}
              {dataSource.length ? (
                <div className="rounded-b-medium bg-secondary">
                  {dataSource.map((row) => (
                    <div
                      key={row.key}
                      className={`gap-medium p-medium lg:px-large grid items-center border-t border-t-white/5 text-sm font-medium transition-colors ${
